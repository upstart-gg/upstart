...
export const jobBoardCompanySchema = Type.Object(
  {
...
export const jobBoardListingSchema = Type.Array(
  Type.Object({
    id: Type.String({
      title: "Job ID",
...
export type JobBoardCompanyType = Static<typeof jobBoardCompanySchema>;
export type JobBoardListingType = Static<typeof jobBoardListingSchema>;
