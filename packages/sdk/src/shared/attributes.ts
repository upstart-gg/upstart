...
const defaultAttributes = {
	...
	$pageOgImage: optional(
		string("Social share image", {
			...
			"ai:guidelines":
				"Don't generate this property/image, it is automatically generated.",
			"ui:group": "meta",
			"ui:field": "image",
		}),
	),
	...
	$robotsIndexing: optional(
		boolean("Allow search engines to index this site", true, {
			description:
				"Disabling this will prevent search engines from indexing this site",
			"ai:guidelines":
				"Don't generate this property/image, it is automatically generated.",
			"ui:group": "seo",
			"ui:group:title": "SEO",
	...
	$siteOgImage: optional(
		string("Social share image", {
			...
			"ai:guidelines":
				"Don't generate this image, it is automatically generated.",
			"ui:field": "image",
			"ui:group": "meta",
			"ui:group:title": "Meta tags",
			"ui:scope": "site",
	...
	$pageTitle: string("Title", {
		...
		"ui:group:title": "Meta tags",
		description:
			"The title of the page. Appears in the browser tab and search results",
	}),
	...
	$siteHeadTags: optional(
		Type.String({
			...
			"ai:guidelines":
				"Don't include meta tags here, they are automatically generated.",
			"ui:multiline": true,
...
export type AttributesSchema = typeof defaultAttributesSchema &
	Record<string, unknown>;

export type Attributes<
	T extends Record<string, unknown> = Record<string, unknown>,
> = Static<typeof defaultAttributesSchema> & T;
...
export function resolveAttributes(
	...
	>;
	return { ...defaultAttrValues, ...data } as Attributes<
		Static<typeof customAttrsSchema>
	>;
}
