	...
	return Type.Union(
		[
			...
			Type.Literal("surface-2", {
				title: "Surface 2",
				description:
					"Surface elevation 2, slightly darker background with dark text.",
			}),
			Type.Literal("surface-3", {
				title: "Surface 3",
				description:
					"Surface elevation 3, even darker background with dark text.",
			}),
			...
			Type.Literal("subtle-secondary", {
				...
				description:
					"Subtle display on secondary-100 background and 1px border.",
			}),
