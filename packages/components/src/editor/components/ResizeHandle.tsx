    ...
    >
      <div
        className={tx(
          ...
          {
            "top-1/2 -translate-y-1/2 -left-1.5": direction === "w",
            "top-1/2 -translate-y-1/2 -right-1.5": direction === "e",
            "left-1/2 -translate-x-1/2 -top-1.5": direction === "n",
            "left-1/2 -translate-x-1/2 -bottom-1.5": direction === "s",
