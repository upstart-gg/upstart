...
export default function PanelSectionInspector({
	section,
}: { section: Section }) {
			...
			<div className="basis-1/2 grow-0">
				<Callout.Root size="1" className="m-2">
					<Callout.Text size="1">
						...
						pre-configured settings that can be applied to your bricks to
						quickly change their appearance. Start from a preset and customize
						it further in the <span className="font-semibold">Settings</span>{" "}
						tab.
					</Callout.Text>
				</Callout.Root>
				<div className="grid grid-cols-3 gap-2 mx-2 auto-rows-[3rem]">
                   ...
                   rounded-md hover:opacity-80`,
								section.props.preset === preset.const &&
