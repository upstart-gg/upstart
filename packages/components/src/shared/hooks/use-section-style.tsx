...
import {
	LAYOUT_COLS,
	LAYOUT_ROW_HEIGHT,
} from "@upstart.gg/sdk/shared/layout-constants";
...
export function useSectionStyle({
	...
	return tx(
		"flex w-full py-0 group/section overflow-visible relative mx-auto max-sm:max-w-dvw",
		[
			...
			typeof section.props.layout?.wrap === "undefined" ||
			section.props.layout?.wrap === true
				? "flex-wrap"
				: "flex-nowrap",
			...
			!!section.props.background &&
				getBackgroundStyles(section.props.background),
...
function getSectionEditorStyles({
	section,
	editable,
	selected,
	previewMode,
