...
const Card = forwardRef<HTMLDivElement, BrickProps<Manifest>>(
	({ brick, editable }, ref) => {
		...
		if (!props.cardTitle && !props.cardBody) {
			...
			props.cardBody =
				"This is the body of the card. You can edit this content.";
		}

		const isOverlay =
			props.cardImage && props.variants?.includes("image-overlay");
		return (
			<div
				className={tx(
